        ...
        <div className="hidden rounded-[2rem] bg-slate-900 p-10 text-white shadow-soft lg:block">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-300">Organização simples para times pequenos</p>
            </div>
          </div>
          <div className="mt-16 max-w-md space-y-5">
            <h2 className="text-4xl font-semibold leading-tight">Acompanhe o projeto ativo, organize tarefas e mantenha o fluxo em movimento.</h2>
            <div className="space-y-3 text-sm text-slate-300">
              <div className="flex items-center gap-3"><CheckCircle2 className="h-4 w-4" /> Login e registro rápidos</div>
              <div className="flex items-center gap-3"><FolderKanban className="h-4 w-4" /> Um projeto ativo por equipe</div>
              <div className="flex items-center gap-3"><ListTodo className="h-4 w-4" /> Quadro com etapas do fluxo de trabalho</div>
            </div>
          </div>
        </div>
