...
func NovoListarTasksPorProjectUseCase(projects projectports.ProjectRepository, tasks taskports.TaskRepository) *ListarTasksPorProjectUseCase {
	return &ListarTasksPorProjectUseCase{projects: projects, tasks: tasks}
}

func (uc *ListarTasksPorProjectUseCase) Executar(req taskdto.ListarTasksPorProjectRequest) (taskdto.ListarTasksPorProjectResponse, error) {
